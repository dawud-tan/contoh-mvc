...
/**
 * Jersey uses this hook while initializing the application. This class taps
 * into this and registers the Jersey application as a Servlet Filter instead
 * the default, which is as a Servlet. see
 * https://github.com/psamsotha/jersey-web-initializer
 */
public class AsFilterServletContainerProvider implements ServletContainerProvider {
    ...
    /**
     * Searches for a single Application class that is used for the Jersey
     * configuration. This can be a JAX-RS {@code javax.ws.rs.core.Application}
     * or a Jersey {@code org.glassfish.jersey.server.ResourceConfig}.
     *
     * @param classes the set of classes discovered by the Servlet container.
     * @return an Application class annotated with {@code @ApplicationPath}, or
     * null of one is not found.
     */
